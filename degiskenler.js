...
string= Metinsel İfaedeler ve Mutlaka tırnak içerisinde yazılır
number=Bunlarda Sayısasl değerlerdir olduğu gibi yazılır

*** Bir değerin metin mi number mı olduğunu anlamak için eğer matemiksel bir 
işlem yapıalcaksa number dır değilse string
*/
